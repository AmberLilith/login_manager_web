        ...
        <Container>
            <Row>
                ...
                <Col className={theme.auth.formContainer}>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit(onSubmit)} className={theme.auth.form}>
                        <Form.Group className="mb-3">
                            ...
                            {errors.userName && <span className='text-danger'>{selectedLanguage.inputUserErrorMessage}</span>}
                        </Form.Group>
                        <Form.Group className="mb-3">
